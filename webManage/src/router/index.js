...
export const constantRouterMap = [
  ...
  // { path: '/login', component: _import('dashboard/index'), hidden: true },
...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      { path: 'apply', component: _import('user/apply'), name: 'apply', meta: { title: '会员审核', noCache: true }},
...

  {
    ...
    children: [
      { path: 'ad', component: _import('promotion/ad'), name: 'ad', meta: { title: '商品推荐', noCache: true }},
  ...
  */

  {
    ...
    children: [
      ...
      { path: 'statistical', component: _import('stat/statistical'), name: 'statistical', meta: { title: '分成统计', noCache: true }},
      { path: 'dividend', component: _import('stat/dividend'), name: 'dividend', meta: { title: '分成明细', noCache: true }},
