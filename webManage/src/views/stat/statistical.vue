<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table size="small" :data="list" v-loading="listLoading" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="获得分成次数" prop="count">
      </el-table-column>
      ...
      <el-table-column align="center" label="获得总提成" prop="money">
      </el-table-column>
...
<script>
import { createUser, updateUser, statisticalUser } from '@/api/user'
...
export default {
  ...
  methods: {
    getList() {
      ...
      statisticalUser(this.listQuery).then(response => {
