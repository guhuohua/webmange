<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table size="small" :data="list" v-loading="listLoading" element-loading-text="正在查询中。。。" border fit
      ...
      <el-table-column align="center" width="100px" label="用户ID" prop="uid" sortable>
      </el-table-column>
      ...
      <el-table-column align="center" label="充值消费" prop="moneyNormal">
      </el-table-column>

      <el-table-column align="center" label="提成部分" prop="moneyLayered">
      </el-table-column>

      <el-table-column align="center" label="剩余余额" prop="moneyCanUsed">
      </el-table-column>

      <el-table-column align="center" label="消费总额" prop="moneyAllUsed">
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form :rules="rules" ref="dataForm" :model="dataForm" status-icon label-position="left" label-width="100px"
        ...
        <!--&lt;!&ndash;<el-input type="password" v-if="dialogStatus === 'update'" v-model="dataForm.password" auto-complete="off"></el-input>&ndash;&gt;-->
        <!--</el-form-item>-->
          ...
          if (valid) {
            createUser(this.dataForm).then(response => {
              if (response.data.msg == "error") {
                this.$notify({title: '失败', message: response.data.res, type: 'error', duration: 2000});
                // this.$refs.dataForm.fields[1].error = response.data.res;
              } else {
